 ...
 */
public class Re_Classify_Right_Adapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Re_Classify_Right_Adapter2(Context context, List<Classify.RsBean.ChildrenBeanX> children,int aa) {
